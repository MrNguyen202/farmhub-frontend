        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <section className="relative bg-gradient-to-b from-green-600 to-green-800 text-white py-20 md:py-24">
                <div className="container mx-auto px-4 text-center">
                    <h1 className="text-3xl md:text-5xl font-bold mb-4">Sứ mệnh của chúng tôi</h1>
            ...
            <section className="py-16">
                <div className="container mx-auto px-4">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="md:flex md:flex-col md:justify-center md:items-center md:text-center md:max-w-xl md:place-self-center lg:text-left lg:items-start">
                            <h2 className="text-4xl mb-2 font-bold text-green-700 md:text-5xl lg:text-4xl xl:mb-6 xl:text-5xl">
                                Vật Tư Nông Nghiệp
                            </h2>
                            <h3 className="text-xl font-thin text-black mb-6 md:text-2xl lg:text-xl xl:text-2xl">
                                Nền tảng vững chắc cho mùa màng bội thu
                            </h3>
                            <p className="text-gray-700 leading-[1.7] mb-4 text-md md:text-lg lg:text-base">
                            ...
                            <p className="text-gray-700 leading-[1.7] text-md md:text-lg lg:text-base">
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4">
                    <div className="grid md:grid-cols-1 xl:grid-cols-3 gap-8">
                        <Card className="text-center h-full p-6 shadow-xl hover:shadow-2xl transition-shadow md:max-w-md md:place-self-center">
                            <CardHeader className="pb-4">
                                <div className="bg-green-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                                    <Target className="w-8 h-8 text-green-600" />
                                </div>
                                <CardTitle className="text-xl font-semibold md:text-2xl lg:text-xl">Sứ mệnh</CardTitle>
                            </CardHeader>
                            <CardContent>
                        ...
                        <Card className="text-center p-6 h-full shadow-xl hover:shadow-2xl transition-shadow md:max-w-md md:place-self-center">
                            <CardHeader className="pb-4">
                                <div className="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                                    <Eye className="w-8 h-8 text-blue-600" />
                                </div>
                                <CardTitle className="text-xl font-semibold md:text-2xl lg:text-xl">Tầm nhìn</CardTitle>
                            </CardHeader>
                            <CardContent>
                                <p className="text-gray-600 text-lg lg:text-base">
                        ...
                        <Card className="text-center p-6 h-full shadow-xl hover:shadow-2xl transition-shadow md:max-w-md md:place-self-center">
                            <CardHeader className="pb-4">
                                ...
                                <CardTitle className="text-xl font-semibold md:text-2xl lg:text-xl">Giá trị cốt lõi</CardTitle>
                            </CardHeader>
                            <CardContent>
                                <p className="text-gray-600 text-lg lg:text-base">
            ...
            <section className="py-16">
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        <Card className="p-6 flex items-start gap-4 shadow-sm hover:shadow-md transition-shadow md:max-w-md md:place-self-center">
                            <Leaf className="w-8 h-8 text-green-600 flex-shrink-0" />
                            <div>
                                <h3 className="text-xl font-semibold mb-2 lg:text-lg">Sản phẩm chất lượng cao</h3>
                        ...
                        <Card className="p-6 flex items-start gap-4 shadow-sm hover:shadow-md transition-shadow md:max-w-md md:place-self-center">
                            ...
                            <div>
                                <h3 className="text-xl font-semibold mb-2 lg:text-lg">Tư vấn kỹ thuật chuyên sâu</h3>
                                <p className="text-gray-600 text-md">
                        ...
                        <Card className="p-6 flex items-start gap-4 shadow-sm hover:shadow-md transition-shadow md:max-w-md md:place-self-center">
                            ...
                            <div>
                                <h3 className="text-xl font-semibold mb-2 lg:text-lg">Giải pháp bền vững</h3>
                                <p className="text-gray-600 text-md">
            ...
            <section className="py-16 bg-green-600 text-white">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        <Button size="lg" className="bg-white text-green-600 hover:bg-green-50 w-2/3 md:w-auto" asChild>
                            <Link href="/products">Khám phá sản phẩm</Link>
                        </Button>
                        <Button
                            size="lg"
                            variant="outline"
                            className="border-white text-white hover:bg-white hover:text-green-600 bg-transparent w-2/3 md:w-auto"
                            asChild
                        >
